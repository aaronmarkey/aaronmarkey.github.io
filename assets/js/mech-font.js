const rmgFont = {
  ...
  getRandom(fontList) {
    const index = randomInt(0, fontList.length - 1);
    return fontList[index];
  },
  getBody() {
    return this.getRandom(this.families.body);
  },
  getCode() {
    return this.getRandom(this.families.code);
  },
  getHeader() {
    return this.getRandom(this.families.header);
  },
  getAll() {
  ...
  getNode(link) {
    ...
    node.class = SELECTORS.class.mech.randFontLink;
    node.href = link;
    node.rel = "stylesheet";
    return node;
  },
