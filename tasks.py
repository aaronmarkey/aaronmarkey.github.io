...
CONFIG = {
    ...
    "commit_message": f"'Publish site on {datetime.datetime.now(tz=SETTINGS.get("TIMEZONE", "UTC")).date()}'",
...
def clean(_):
    ...
    if Path.is_dir(CONFIG["deploy_path"]):
        shutil.rmtree(CONFIG["deploy_path"])
        Path.mkdir(CONFIG["deploy_path"], parents=True)
